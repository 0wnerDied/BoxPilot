...
public sealed class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["NetworkChangesHint"] = "The first TUN start installs a protected system service and requests administrator approval once.",
            ["ServiceAuthorizationDenied"] = "Administrator approval is required to install the TUN service.",
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChinese =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["TunMode"] = "启用 TUN 模式",
            ["NetworkChangesHint"] = "首次启动 TUN 会安装受保护的系统服务，并仅请求一次管理员授权。",
            ["ServiceAuthorizationDenied"] = "安装 TUN 系统服务需要管理员授权。",
